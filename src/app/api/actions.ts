...
export async function generateAccessToken(identityProviderUrl: string, projectIdentifier: string, privateApiKey) {
    ...
    return jsonWebTokenSigner
        .sign(privateKey)
        .then((signedJsonWebToken) => axios.post(`${identityProviderUrl}/oauth/v2/token`, {
